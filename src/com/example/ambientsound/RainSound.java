...
public class RainSound implements Sound {
    private Clip clip;
    private FloatControl volumeControl;
    private float volume = 0.5f; // 初期音量
    private String name = "Rain";

    public RainSound(String filePath) {
        try {
            // 音声ファイルを読み込む
        	//AudioInputStreamは音声データが入力されたストリームのこと
            AudioInputStream ais = AudioSystem.getAudioInputStream(new File("sounds/rainsound.wav"));
